...
url = "https://www.dropbox.com/scl/fi/qy0x1wy1emhv8pr0nfc7o/4177436.csv?rlkey=grqo6ds6d8ysob0jpxtlwam8t&dl=1"
...
paydate_diff = lastTwoTransactions.groupby("bankAcctID").apply(lambda x: (x["date"].iloc[-1] - x["date"].iloc[0]).days if len(x) > 1 else np.nan).rename("predicted")
